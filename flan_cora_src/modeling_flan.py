...
class JointEncoder(T5Stack):  # not single block, but the entire Encoder
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            ###
            #self.embed_tokens.weight.data[-169343:]=torch.zeros(2708,1024).to(input_ids.device)
        ...
        **kwargs,
        ...
        if labels is not None:
            if reduce_loss:
                ...
                loss_fct = CrossEntropyLoss(ignore_index=-100, reduction='none')  # Notably, we set reduction == none for detailed loss logging
            loss = loss_fct(
