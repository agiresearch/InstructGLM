...
template['source']="node_{} is connected with {} within one hop. Which other node will be connected to node_{} within one hop?"
...
template['source'] = "node_{} linked to nodes within one hop in the following order: {}. Which node is most likely to be the next node to connect to node_{}?"
...
template['source']="node_{} is connected with {} within one hop. Will node_{} be connected with node_{} within one hop?"
#template['source'] = "Given the following purchase history of user_{} : \n {} \n predict next possible item to be purchased by the user ?"
template['target'] = "{}"
template['task'] = "link"
...
template['source']="node_{} linked to nodes within one hop in the following order: {}. Will node_{} be the next node to be connected with node_{}?"
#template['source'] = "Given the following purchase history of user_{} : \n {} \n predict next possible item to be purchased by the user ?"
template['target'] = "{}"
template['task'] = "link"
template['source_argc'] = 4
...
all_tasks['link'] =  task_subgroup_6
##
